...
def lista_projetos(request):
    ...
    if categoria_id:
        projetos = projetos.filter(categoria__id=categoria_id)

    categorias = Categoria.objects.all()#recupero todas as categorias
...
def meus_projetos(request):
    ...
    projetos_recentes = Projeto.objects.order_by('-data_criacao')[:5]
